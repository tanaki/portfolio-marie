...
var top=$("#logo").position().top-73;var left=$("#logo").position().left-353;if($(window).width()<$(".content-inner").width()){left=Math.round(($(window).width()-$(".content-inner").width())/2)+13;}
